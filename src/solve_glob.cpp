...
// appends the inviscid/viscous edge-velocity coupling residual rows (ue = ue_inv + mass influence) and their Jacobian columns to the system built
// by build_glob_RV, then (when doSolve) calls solve_sys (sparselinsolve.hpp) to produce glob.dU.
#include <iostream>
#include <cmath>
#include <Eigen/Dense>
#include <Eigen/LU>
